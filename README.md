...
Plantilla para el desarrollo de interfaces web de tipo Dashboard-Admin basado en  Angular 10+ con Typescrip  y Bootstrap 4+ con SCSS

Incluye elementos con los packetes
...
En el archivo `src/enviroments/globals.ts` editar la variable `url.logo`

```javascript
export const globals = {
    url:{
        logo: 'https://risk.azurewebsites.net/assets/img/logos/logo_full_riesgos360.svg'
    }
  };
```
